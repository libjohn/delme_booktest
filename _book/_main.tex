...
\CommentTok{\# library(gt)  \# https://gt.rstudio.com/}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tab:unnamed-chunk-7}Another nice table!}
\centering
...
The above is done with \texttt{\$\$f(k)\ =\ \{n\ \textbackslash{}choose\ k\}\ p\^{}\{k\}\ (1-p)\^{}\{n-k\}\$\$}

\href{https://bookdown.org/yihui/rmarkdown/rticles-latex.html}{Recommendation to R Markdown syntax unless} there are specific requirements for using LaTeX.

Read more about \href{https://bookdown.org/yihui/bookdown/markdown-syntax.html\#math-expressions}{Markdown syntax for Math expressions}
